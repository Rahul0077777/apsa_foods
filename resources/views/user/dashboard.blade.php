            ...
            <div class="bg-white p-8 rounded-xl shadow">
                ...
                <form method="POST" action="{{ route('user.profile.update') }}"
                    ...
                    <div>
                        ...
                        <input name="email" type="email" value="{{ $user->email }}" class="w-full rounded-lg border p-3">
                    </div>
                    ...
                    <div>
                        <label class="text-sm font-semibold">New Password (leave blank to keep current)</label>
                        <input name="password" type="password" class="w-full rounded-lg border p-3">
                    </div>

                    <div>
                        <label class="text-sm font-semibold">Confirm New Password</label>
                        <input name="password_confirmation" type="password" class="w-full rounded-lg border p-3">
                    </div>
