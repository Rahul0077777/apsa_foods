        ...
        <div class="bg-white p-5 rounded-xl border shadow-sm">
            ...
            @forelse($distributors as $d)
                    <div class="flex items-start gap-3 mb-4">
                        ...
                        <div class="flex-1">
                            <p class="font-semibold">{{ $d->business_name }}</p>
                            <p class="text-xs text-gray-500">{{ $d->city_state }} · {{ $d->partnership_type }}</p>
                            <p class="text-xs text-gray-400 mt-0.5">{{ $d->created_at->diffForHumans() }}</p>
                        </div>
                    </div>
                @empty
