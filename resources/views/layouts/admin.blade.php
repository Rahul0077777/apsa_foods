            ...
            <div class="flex flex-col h-full p-4">
                ...
                {{ request()->routeIs('customers.*') ? 'bg-primary/10 text-primary font-semibold' : 'hover:bg-gray-100 dark:hover:bg-zinc-800' }}">
                    ...
                    <a href="{{ route('admin.blogs') }}"
                        ...
                        <a href="{{ route('admin.partnership.requests') }}"
                            class="px-3 py-2 rounded-lg flex items-center gap-2
                            {{ request()->routeIs('admin.partnership.*') ? 'bg-primary/10 text-primary font-semibold' : 'hover:bg-gray-100 dark:hover:bg-zinc-800' }}">
                ...
                <div class="mt-auto border-t pt-4">
                    ...
                    <a href="{{ route('admin.profile') }}"
                        class="mt-3 flex items-center gap-2 text-sm px-3 py-2 rounded-lg transition
                        {{ request()->routeIs('admin.profile') ? 'bg-primary/10 text-primary font-semibold' : 'hover:bg-gray-100 dark:hover:bg-zinc-800' }}">
                        <span class="material-symbols-outlined text-base">manage_accounts</span> My Profile
                    </a>

                    <form method="POST" action="{{ route('logout') }}" class="mt-1">
                        @csrf
                        <button class="text-red-500 text-sm flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition w-full">
