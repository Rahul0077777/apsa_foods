        ...
        <div class="flex flex-col md:flex-row gap-12 items-start">
            <div class="flex-1 max-w-lg">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                    At APSA Foods, we believe drinks should do more than just thandak dena—they should refresh hard, hit
                    right, and feel good. That’s why our beverages are made with top-quality ingredients, modern
                    processes, and strict quality checks, so every bottle delivers full taste and trusted hydration—no
                    compromises.
                </p>
                <a href="{{ url('/about') }}">
...
<!-- BRAND STORY SECTION -->
<!--<section class="py-24 px-4 md:px-10 lg:px-40 bg-white dark:bg-[#0c180c]">-->
...
<!--                It’s India’s answer to the café craze.-->
<!--            </p>-->

<!--            <p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">-->
<!--                A D2C brand that serves authentic, fizzy mojitos — straight from the maker to your fridge.-->
<!--                No middlemen. No dilution. Just pure freshness in every sip.-->
<!--            </p>-->

<!--            <p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">-->
<!--                We’ve taken the global mojito trend and given it a proudly Indian identity —-->
<!--                minty, tangy, fizzy, and perfectly crafted for our taste buds.-->
<!--            </p>-->

<!--            <p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">-->
<!--                Whether it’s a house party, study break, or chilling with friends,-->
<!--                Gupta Ji Ki Mojito makes every moment feel café-style cool.-->
<!--            </p>-->

<!--            <p class="font-bold text-primary">-->
<!--                India Ka Apna Mojito — refreshing, affordable, and full of café vibe.-->
<!--            </p>-->
<!--        </div>-->
...
<!--                class="max-h-[420px] object-contain drop-shadow-xl"-->
<!--            />-->
<!--        </div>-->
...
">
  ...
  />
        ...
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
               We had served millions of cups, shared countless conversations, and witnessed one constant truth — people don’t just consume beverages, they connect with them.
            </p>

            <p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
               Cold drinks after long days. Water during quiet moments. Flavors tied to memories.Yet, as the market grew crowded, something felt missing.
            </p>
