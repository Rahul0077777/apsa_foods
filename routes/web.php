...
Route::middleware(['auth','admin'])->prefix('admin')->group(function () {
  ...
  Route::resource('distributor',
    ...
    Route::get('/partnership-requests', [AdminDashboardController::class, 'partnershipRequests'])->name('admin.partnership.requests');
    Route::delete('/partnership-requests/{id}', [AdminDashboardController::class, 'destroyPartnership'])->name('admin.partnership.destroy');

    // Admin Profile
    Route::get('/profile', [AdminDashboardController::class, 'profile'])->name('admin.profile');
    Route::post('/profile/update', [AdminDashboardController::class, 'updateProfile'])->name('admin.profile.update');
    Route::post('/profile/password', [AdminDashboardController::class, 'updatePassword'])->name('admin.password.update');
