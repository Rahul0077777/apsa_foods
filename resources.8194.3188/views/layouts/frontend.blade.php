            ...
            <div class="flex items-center gap-8">
                ...
                <nav class="hidden lg:flex items-center gap-8">
                    ...
                    <a class="text-sm font-medium hover:text-primary transition-colors"
                        href="{{ url('/wholesale') }}">Wholesale</a>
                    <a class="text-sm font-medium hover:text-primary transition-colors"
            ...
            <div class="flex items-center gap-4 md:gap-6">
                ...
                <form action="{{ route('shop') }}" method="GET" class="hidden md:flex w-full max-w-xs relative group">
                    ...
                    <input name="search" value="{{ request('search') }}"
                        ...
                        placeholder="Search juices..." type="text">
                </form>
...
">
                        ...
                        <a href="{{ url('/wholesale') }}" class="hover:text-primary">Wholesale</a>
                        ...
                        <form action="{{ route('shop') }}" method="GET" class="w-full relative group mt-2">
                            ...
                            <input name="search" value="{{ request('search') }}" type="text"
                                placeholder="Search juices..." class="w-full rounded-xl border border-[#e7f3e7] 
    ...
    <footer class="bg-[#1a331a] dark:bg-black text-white pt-20 pb-10">
        <div class="container mx-auto px-4 md:px-10 lg:px-40">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-10 pb-20 border-b border-white/10">
                ...
                <div class="w-full md:w-auto flex-1 max-w-md">
                    <form action="{{ route('subscribe') }}" method="POST" class="flex gap-3">
                        @csrf
                        <input type="email" name="email" placeholder="Enter your email"
                            class="bg-green-900/40 text-white px-4 py-3 rounded-lg w-80" required>

                        <button type="submit"
                            class="bg-primary text-[#0d1b0d] font-bold h-12 px-6 rounded-lg hover:bg-primary/90 transition-colors">
                            Subscribe
                        </button>
                    </form>
                </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-10 py-16">
                <div>
                    ...
                    <ul class="space-y-4 text-white/70">
                        <li><a class="hover:text-primary transition-colors" href="#">All Juices</a></li>
                        <li><a class="hover:text-primary transition-colors" href="#">Cleanses</a></li>
                        <li><a class="hover:text-primary transition-colors" href="#">Shots</a></li>
                    </ul>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-white/70">
                        ...
                        <li><a class="hover:text-primary transition-colors" href="{{ url('/wholesale') }}">Wholesale</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-4 text-white/70">
                        ...
                        <li><a class="hover:text-primary transition-colors" href="{{'/return-refund-policy'}}">Refund Policy</a></li>
        ...
        <path d="M14.821 11.417c-.198 0-.376-.017-.532-.051.156.541.234 1.155.234 1.841 0 1.25-.333 2.195-.998 2.834-.666.64-1.57.96-2.712.96-1.124 0-1.996-.302-2.614-.906-.619-.604-.928-1.472-.928-2.604 0-1.161.34-2.072 1.021-2.733.68-.661 1.62-.992 2.818-.992.54 0 1.053.07 1.54.21.054-.92-.128-1.636-.547-2.146-.419-.51-.986-.765-1.7-.765-.892 0-1.673.344-2.342 1.031L6.75 6.132C7.887 5.013 9.255 4.453 10.852 4.453c1.378 0 2.47.43 3.275 1.291.805.86 1.166 2.053 1.084 3.578l.006.012c.703.337 1.216.848 1.538 1.534.322.686.483 1.487.483 2.404 0 2.062-.577 3.655-1.73 4.78C14.354 19.176 12.7 19.74 10.547 19.74c-2.32 0-4.148-.713-5.485-2.14-1.336-1.426-2.004-3.418-2.004-5.977 0-2.522.66-4.49 1.98-5.904C6.357 4.305 8.163 3.6 10.457 3.6c1.196 0 2.316.21 3.361.63l-.703 1.64c-.812-.312-1.697-.468-2.658-.468-1.758 0-3.155.534-4.192 1.602-1.037 1.068-1.555 2.593-1.555 4.576 0 1.95.492 3.486 1.477 4.608.984 1.122 2.347 1.683 4.088 1.683 1.67 0 2.946-.425 3.826-1.275.88-.85 1.321-2.083 1.321-3.698 0-.668-.103-1.23-.309-1.686-.206-.456-.513-.772-.921-.948zm-5.076 1.644c0 .644.153 1.11.459 1.398.306.287.7.431 1.183.431.516 0 .914-.143 1.192-.43.279-.286.418-.751.418-1.393 0-.64-.142-1.114-.426-1.42-.284-.306-.71-.459-1.277-.459-.536 0-.946.155-1.23.465-.284.31-.427.784-.427 1.422z" />
            ...
            <!-- Copyright -->
            <div
                class="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 text-white/50 text-sm">
                ...
                <div class="flex gap-6 mt-4 md:mt-0">
                    <a class="hover:text-white" href="{{ url('/privacy-policy') }}">Privacy Policy</a>
                    <a class="hover:text-white" href="{{ url('/terms-and-conditions') }}">Terms & Conditions</a>
                </div>
            </div>
        </div>
    </footer>
