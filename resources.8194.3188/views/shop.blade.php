...
<label class="flex items-center gap-3 cursor-pointer group">
    ...
    <span class="text-sm group-hover:text-primary">
        {{ $cat->name }}
    </span>
</label>
@endforeach
...
<input type="range" name="max_price" min="0" max="2000"
       value="{{ request('max_price', 2000) }}"
       class="w-full accent-primary">

<div class="flex justify-between text-sm mt-2">
    <span>₹0</span>
    <span>₹{{ request('max_price', 2000) }}</span>
</div>

<button class="mt-4 w-full bg-primary text-black py-2 rounded font-bold">
    Apply Filters
</button>
