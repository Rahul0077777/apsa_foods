...
<div class="flex">
    ...
    <!-- Sidebar -->
    <aside class="w-64 fixed inset-y-0 left-0 bg-white dark:bg-zinc-900 border-r border-slate-200 dark:border-zinc-800">
        <div class="flex flex-col h-full p-4">

            <div class="flex items-center gap-3 mb-8">
                <img src="{{ asset('assets/logo.png') }}" class="w-12 h-12 object-contain" alt="al'sa Logo">
            </div>
